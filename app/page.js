  ...
  return (
    <Box className=" bg-[#FE9534]">
      <div className=" lg:mt-[55px] lg:w-8/12 w-full m-auto">
        <Box>
          <Text className=" lg:text-[30px] text-[20px] text-center font-semibold text-white  mt-[40px]">
            Log in
          </Text>
        </Box>
            ...
            <div className=" lg:w-9/12 lg:ml-auto mr-auto w-11/12 ml-auto">
              ...
              <div className="grid lg:mt-[100px] mt-[30px]">
                ...
                <p className=" text-[15px] mb-[32px] lg:pt-[80px] pt-[20px] font-medium text-white leading-10 lg:leading-12">
                  Welcome to Zendit Technology Admin dashboard Carefully input
                  your login details to get started on today’s activities.
                </p>
              </div>
            </div>
            <Box
              borderRadius={"lg"}
              className=" lg:hidden grid w-11/12 m-auto rounded-lg bg-[#FE9534] pt-[20px] mt-[20px] mb-[30px] pb-[20px]"
            >
