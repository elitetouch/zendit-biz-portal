...
import { Box, TabPanel, TabPanels, Text , Tabs, TabList, Tab, IconButton, Input, Button} from '@chakra-ui/react'
...
export const OrderCards=({name, status, orderCode, packageNumber, location})=>{
  return (
    <Box 
...
<rect width="24" height="24" fill="white" transform="translate(0 0.335938)"/>
              ...
              <Box className=' h-[27px] w-[94px] bg-[#DEEBFC] grid items-center justify-center rounded-l-full rounded-r-full'>
                <Text className=' text-[#031966] text-[13px]'>{packageNumber} packages</Text>
              </Box>
            </Box>
...
<path d="M10.001 0.835938C6.73078 0.835938 4.05078 3.50794 4.05078 6.76914C4.05078 8.03274 4.45438 9.20714 5.13738 10.1723L9.27478 17.3249C9.85418 18.0819 10.2394 17.9381 10.7212 17.2849L15.2848 9.51894C15.3768 9.35214 15.4492 9.17454 15.5122 8.99314C15.8018 8.28743 15.9507 7.53195 15.9506 6.76914C15.9508 3.50794 13.2716 0.835938 10.001 0.835938ZM10.001 3.61594C11.7622 3.61594 13.1626 5.01314 13.1626 6.76914C13.1626 8.52514 11.7622 9.92174 10.001 9.92174C8.23998 9.92174 6.83898 8.52534 6.83898 6.76914C6.83898 5.01314 8.23998 3.61614 10.001 3.61614V3.61594Z" fill="#FE9534"/>
<path d="M13.7826 10.6172L13.773 10.6424C13.776 10.6348 13.7784 10.627 13.7814 10.6194L13.7826 10.6172ZM6.8012 14.647C3.976 15.0462 2 16.0012 2 17.407C2 19.3006 5.3016 20.8356 10 20.8356C14.6984 20.8356 18 19.3006 18 17.407C18 16.0012 16.0242 15.0462 13.1992 14.647L12.8078 15.3134C14.937 15.6088 16.4 16.2296 16.4 16.95C16.4 17.96 13.5346 18.7786 10 18.7786C6.4654 18.7786 3.6 17.96 3.6 16.95C3.5998 16.232 5.0532 15.6118 7.189 15.3152C7.06 15.0924 6.9304 14.87 6.8012 14.647Z" fill="#FE9534"/>
</g>
<defs>
...
<path d="M11.6751 2.15039H7.75555C6.37219 2.15039 6.06478 2.84208 5.88802 3.69515L5.25781 6.7078H14.1728L13.5426 3.69515C13.3659 2.84208 13.0585 2.15039 11.6751 2.15039Z" stroke="#FF5252" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M15.2777 11.6179C15.3392 12.2711 14.8166 12.8322 14.148 12.8322H13.1028C12.5033 12.8322 12.4188 12.5785 12.3112 12.2558L12.1959 11.9253C12.0422 11.4718 11.9423 11.1644 11.1353 11.1644H8.28404C7.48477 11.1644 7.3618 11.5102 7.22346 11.9253L7.10819 12.2558C7.00059 12.5709 6.91605 12.8322 6.3166 12.8322H5.27139C4.60276 12.8322 4.08016 12.2711 4.14164 11.6179L4.45674 8.22095C4.53359 7.38325 4.69498 6.69922 6.1552 6.69922H13.2642C14.7244 6.69922 14.8858 7.38325 14.9626 8.22095L15.2777 11.6179Z" stroke="#FF5252" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M5.25634 5.03125H4.69531" stroke="#FF5252" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M14.729 5.03125H14.168" stroke="#FF5252" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M6.37109 8.93555H8.03883" stroke="#FF5252" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M11.3906 8.93555H13.0584" stroke="#FF5252" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M9.71484 13.6777V14.4463" stroke="#FF5252" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M9.71484 16.752V17.5205" stroke="#FF5252" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M2.79588 14.4473L2.02734 17.5214" stroke="#FF5252" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M16.6328 14.4473L17.4013 17.5214" stroke="#FF5252" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
}
            title={'Pending'} 
            Total_number={'300'}
...
<path d="M20.9297 18.1445L21.8864 21.9715" stroke="#1EBD5D" stroke-width="1.43511" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <Box>
            ...
            routeFunc={()=>setItemsPage(1)}
            icon={<svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M11.9681 2.15039H8.04852C6.66516 2.15039 6.35775 2.84208 6.18099 3.69515L5.55078 6.7078H14.4658L13.8356 3.69515C13.6588 2.84208 13.3514 2.15039 11.9681 2.15039Z" stroke="#1EBD5D" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M15.5707 11.6179C15.6322 12.2711 15.1096 12.8322 14.4409 12.8322H13.3957C12.7963 12.8322 12.7117 12.5785 12.6041 12.2558L12.4889 11.9253C12.3351 11.4718 12.2352 11.1644 11.4283 11.1644H8.57701C7.77774 11.1644 7.65477 11.5102 7.51643 11.9253L7.40115 12.2558C7.29356 12.5709 7.20902 12.8322 6.60956 12.8322H5.56436C4.89573 12.8322 4.37312 12.2711 4.43461 11.6179L4.74971 8.22095C4.82656 7.38325 4.98795 6.69922 6.44817 6.69922H13.5571C15.0173 6.69922 15.1787 7.38325 15.2556 8.22095L15.5707 11.6179Z" stroke="#1EBD5D" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M5.54931 5.03125H4.98828" stroke="#1EBD5D" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M15.022 5.03125H14.4609" stroke="#1EBD5D" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M6.66406 8.93555H8.33179" stroke="#1EBD5D" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M11.6836 8.93555H13.3513" stroke="#1EBD5D" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M10.0078 13.6777V14.4463" stroke="#1EBD5D" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M10.0078 16.752V17.5205" stroke="#1EBD5D" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M3.08885 14.4473L2.32031 17.5214" stroke="#1EBD5D" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M16.9258 14.4473L17.6943 17.5214" stroke="#1EBD5D" stroke-width="1.1528" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
}
            title={'Delivered'} 
            Total_number={'300'}
...
<circle cx="6" cy="6.83594" r="6" fill="#398EF1"/>
            ...
            <Box>
              <Text className=' text-[14px] text-[#A098AE]'>3 riders in transit</Text>
            </Box>
          </Box>
    ...
    <Box>
      ...
      >
        <Box className="flex items-center gap-x-[10px] justify-center pl-[10px] pr-[10px]">
          {/* Add Rider Icon */}
        <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M10.8346 8.33529C10.8346 7.87505 10.4615 7.50195 10.0013 7.50195C9.54107 7.50195 9.16797 7.87505 9.16797 8.33529V10.002H7.5013C7.04107 10.002 6.66797 10.3751 6.66797 10.8353C6.66797 11.2955 7.04107 11.6686 7.5013 11.6686H9.16797V13.3353C9.16797 13.7955 9.54107 14.1686 10.0013 14.1686C10.4615 14.1686 10.8346 13.7955 10.8346 13.3353V11.6686H12.5013C12.9615 11.6686 13.3346 11.2955 13.3346 10.8353C13.3346 10.3751 12.9615 10.002 12.5013 10.002H10.8346V8.33529Z" fill="white"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M10.0013 2.50195C5.39893 2.50195 1.66797 6.23291 1.66797 10.8353C1.66797 15.4377 5.39893 19.1686 10.0013 19.1686C14.6037 19.1686 18.3346 15.4377 18.3346 10.8353C18.3346 6.23291 14.6037 2.50195 10.0013 2.50195ZM3.33464 10.8353C3.33464 7.15339 6.3194 4.16862 10.0013 4.16862C13.6832 4.16862 16.668 7.15339 16.668 10.8353C16.668 14.5172 13.6832 17.502 10.0013 17.502C6.3194 17.502 3.33464 14.5172 3.33464 10.8353Z" fill="white"/>
</svg>
