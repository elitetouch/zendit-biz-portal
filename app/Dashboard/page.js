      ...
      <Box className=" flex items-center gap-x-[10px]">
        ...
        <Box>
          <Box
            ...
            color={"white"}
            className=" h-[40px] w-[40px] lg:text-[14px] text-[12px] rounded-full grid justify-center items-center"
          >
            <Text>1</Text>
          </Box>
        </Box>
    ...
    <div>
            ...
            <Menu>
              ...
              {/* <MenuList>
                <Box className=" pl-[2px]">
                  <Text className=" lg:text-[14px] text-[12px]">GUO</Text>
                </Box>
              </MenuList> */}
            </Menu>
          </Box>
            ...
            <Box>
              <DashboardCard
                ...
                icon={
                  ...
                  >
                    <path
                      d="M14.352 2.83594H9.47268C7.75055 2.83594 7.36786 3.69701 7.14781 4.75899L6.36328 8.50938H17.4614L16.6769 4.75899C16.4569 3.69701 16.0742 2.83594 14.352 2.83594Z"
                      stroke="#A098AE"
                      stroke-width="1.43511"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    ...
                    />
                    <path
                      d="M3.30049 18.1445L2.34375 21.9715"
                      stroke="#A098AE"
                      stroke-width="1.43511"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M20.5234 18.1445L21.4802 21.9715"
                      stroke="#A098AE"
                      stroke-width="1.43511"
                      stroke-linecap="round"
                      stroke-linejoin="round"
      ...
      <Box className=" lg:mt-[50px] mt-[20px] ">
        <Tabs>
          ...
          >
            <Tab>
              <h1 className=" lg:text-[16px] text-[14px] text-[#031966] text-center">
                All Orders
              </h1>
            </Tab>
            <Tab>
          ...
          <TabPanels>
            ...
            <TabPanel>
              <AssignedTable status={"Returned"} />
            </TabPanel>
            <TabPanel>
              <AssignedTable status={"Completed"} />
            </TabPanel>
          </TabPanels>
        </Tabs>
      </Box>
