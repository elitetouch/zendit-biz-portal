...
import FinancePartnersTable from "@/app/Components/Table/FinancePartners";
function Page() {
  return (
      ...
      <Box>
        ...
        <Box>
          <Box className=" mt-[20px] ml-[20px] mr-[20px] bg-white rounded-lg">
            ...
            <Box>
              <Tabs>
                <TabList className=" border-b-[1px] border-b-gray-300 mt-[20px] w-11/12 m-auto">
                  <Tab
                    _selected={{
                      color: "#398EF1",
                      borderBottom: "2px solid #398EF1",
                    }}
